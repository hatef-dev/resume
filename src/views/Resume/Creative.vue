          ...
          >
            ...
            <div v-for="(section, i) in sections" :key="i">
              <div class="flex-1 flex flex-col">
                <!-- Header -->
                <div v-if="section.type === 'header'" class="flex justify-between items-center">
                  <div>
            ...
            <div class="grid grid-cols-3">
              <aside class="col-span-1 min-h-[297mm] border-r border-gray-700 flex flex-col">
                <div v-for="(section, i) in sections" :key="i">
                  <!-- Contact info -->
                  <div v-if="section.type === 'header'" class="border-b border-gray-700 mr-10 py-6">
                    <div class="flex flex-col gap-4 mt-2 text-[14px] resumeGrayText">
                      <div v-if="section.contacts.phone" class="flex items-center gap-2">
                        ...
                        <span>{{ section.contacts.phone }}</span>
                      </div>
                  ...
                  <div
                    ...
                    class="border-b border-gray-700 mr-10 py-6 flex flex-col gap-y-2"
                  >
              ...
              <aside class="col-span-2">
                <div v-for="(section, i) in sections" :key="i">
                  ...
                  >
                    ...
                    <div v-for="(content, i) in section.content" :key="i" class="text-base">
                      {{ content }}
                    </div>
                  </div>
                  <!-- Experience -->
                  ...
                  >
                    <div class="">
                      <div class="flex flex-col gap-y-1">
                        <h2 class="text-xl red-hat-display tracking-[0.1em] uppercase">
                          {{ section.title }}
                        </h2>
                      </div>
                    </div>
